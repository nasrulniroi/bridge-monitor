...
import './globals.css'
export const metadata: Metadata = { title: 'Bridge Monitor', description: 'Real-time bridge transaction monitoring across Hop, Stargate, Across, Wormhole, ' }
      ...
      <nav className="border-b border-[var(--border)] bg-[var(--surface)] sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold">Bridge Monitor</span>
          </div>
