...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold">Bridge Monitor</h1>
        <p className="text-[var(--muted)] mt-1">Real-time bridge transaction monitoring across Hop, Stargate, Across, Wormhole, LayerZero</p>
      </div>
