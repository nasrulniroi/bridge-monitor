...
Real-time bridge transaction monitoring across Hop, Stargate, Across, Wormhole, LayerZero, and Synapse. Features TVL tracking, latency measurement, fee comparison, and security scoring.
...
git clone https://github.com/nasrulniroi/bridge-monitor.git
cd bridge-monitor
...
# Set up database
psql -c "CREATE DATABASE bridge_monitor"
psql bridge_monitor < database/001_initial.sql
...
```env
DATABASE_URL=postgresql://user:pass@localhost:5432/bridge_monitor
